...
export default async function OnboardingPage({ searchParams }: OnboardingPageProps) {
  ...
  return <main>
    ...
    <form className="card auth-form" aria-labelledby="org-form-heading"><h2 id="org-form-heading">Dados da organização</h2>
      <label>Nome da empresa<input name="name" required minLength={2} maxLength={120} placeholder="Empresa de teste" autoComplete="organization" /></label><p id="org-name-help">Entre 2 e 120 caracteres. No MVP, cada conta usa uma organização.</p>
