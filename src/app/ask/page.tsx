...
export default async function AskPage({ searchParams }: Props) {
  ...
  return <main>
    ...
    {dataWarning && <p role="alert" aria-live="assertive">Algumas métricas não puderam ser carregadas. Não vou gerar uma resposta com métricas incompletas.</p>}
    {answer && <section className="card" aria-live="polite"><span>Resposta</span><strong>{answer.text}</strong>{answer.href && <p><a href={answer.href}>{answer.label} →</a></p>}</section>}
