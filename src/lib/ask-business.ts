...
export function answerBusinessQuestion(question: string, data: BusinessSnapshot): BusinessAnswer {
  ...
  if (/conhecimento|knowledge|factos|preços|precos|serviços|servicos|políticas|politicas/.test(q)) return { text: "Itens de conhecimento aprovados: " + data.approvedKnowledge + ".", href: "/knowledge", label: "Ver Knowledge" };
