...
create unique index if not exists agent_runs_one_completed_per_source_message_idx on public.agent_runs(conversation_id,source_message_id) where status='completed' and source_message_id is not null;
