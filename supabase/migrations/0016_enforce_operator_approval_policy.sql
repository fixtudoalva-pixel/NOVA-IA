-- Server-side policy boundary: Operator proposals cannot self-approve in the MVP.
...
begin
 ...
 where id=p_conversation_id and status<>'closed' and public.is_org_member(organization_id) for update;
