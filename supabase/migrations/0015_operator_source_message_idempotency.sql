-- Mirror live migration: identify Operator runs by the exact inbound customer message.
alter table public.agent_runs add column if not exists source_message_id uuid references public.messages(id);
