...
create policy "members update outcomes" on public.outcomes for update using (public.is_org_member(organization_id)) with check (public.is_org_member(organization_id));
